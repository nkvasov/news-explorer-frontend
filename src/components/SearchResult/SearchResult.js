...
const SearchResult = ({ newsCards, handleShowMoreCardsClick, cardsQuantity, handleNewsSave }) => {
  ...
  return (
    <section className="search-result">
      ...
      <NewsCardList newsCards={newsCardsToRender} handleNewsSave={handleNewsSave} />
